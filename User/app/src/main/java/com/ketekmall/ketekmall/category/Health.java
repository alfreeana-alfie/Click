...
public class Health extends AppCompatActivity {
    ...
    private static String URL_READ = "https://ketekmall.com/ketekmall/category/read_health.php";
    ...
    private static String URL_SEARCH = "https://ketekmall.com/ketekmall/search/read_health.php";
    private static String URL_FILTER_DISTRICT = "https://ketekmall.com/ketekmall/filter_district/read_health.php";
    private static String URL_FILTER_DIVISION = "https://ketekmall.com/ketekmall/filter_division/read_health.php";
    private static String URL_FILTER_SEARCH = "https://ketekmall.com/ketekmall/filter_search_division/read_health.php";
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(Health.this, Homepage.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

//                    case R.id.nav_feed:
//                        Intent intent5 = new Intent(Health.this, Feed_page.class);
//                        intent5.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
//                        startActivity(intent5);
//                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(Health.this, Notification_Page.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(Health.this, Me_Page.class);
    ...
    private void ToolbarSetting() {
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Health.this, Homepage.class);
    ...
    private void Declare() {
        ...
        adapter_division = ArrayAdapter.createFromResource(Health.this, R.array.division, android.R.layout.simple_spinner_item);
                            ...
                            try {
                                ...
                                if(jsonArray.length() == 0){
                                    ...
                                    if (getId.equals(strSeller_id)) {
                                                    ...
                                                    public void onResponse(String response) {
                                                        if (response == null) {
                                                            ...
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(Health.this, "Add To Cart", Toast.LENGTH_SHORT).show();
                                                                } else {
                                                                    Toast.makeText(Health.this, "Failed Adding To Favourite", Toast.LENGTH_SHORT).show();
                                                                }
                                                            } catch (JSONException e) {
                                                                e.printStackTrace();
                                                                Toast.makeText(Health.this, e.toString(), Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                        ...
                                        RequestQueue requestQueue = Volley.newRequestQueue(Health.this);
                                ...
                                if (success.equals("1")) {
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        ...
                                        Toast.makeText(Health.this, "Sorry, Already in the cart", Toast.LENGTH_SHORT).show();
...
//                                Toast.makeText(Homepage.this, "Login! ", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    new Response.Listener<String>() {
                                                        ...
                                                        public void onResponse(String response) {
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(Health.this, "Add To Favourite", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(Health.this, "Login Failed! ", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
