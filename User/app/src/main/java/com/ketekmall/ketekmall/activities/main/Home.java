...
import com.ketekmall.ketekmall.activities.AboutKetekMall;
import com.ketekmall.ketekmall.activities.chats.InboxHome;
...
import com.ketekmall.ketekmall.activities.products.AddNewProductHome;
...
import static com.ketekmall.ketekmall.configs.Constant.ONESIGNAL_APP_ID;
import static com.ketekmall.ketekmall.configs.Constant.hideSoftKeyboard;
import static com.ketekmall.ketekmall.configs.Link.ADD_PLAYER_ID;
import static com.ketekmall.ketekmall.configs.Link.ADD_TO_CART;
import static com.ketekmall.ketekmall.configs.Link.ADD_TO_FAVOURITE;
import static com.ketekmall.ketekmall.configs.Link.GET_ALL_CHAT;
import static com.ketekmall.ketekmall.configs.Link.GET_CART;
import static com.ketekmall.ketekmall.configs.Link.GET_CATEGORY;
import static com.ketekmall.ketekmall.configs.Link.GET_FILTER_DISTRICT;
import static com.ketekmall.ketekmall.configs.Link.GET_FILTER_DIVISION;
import static com.ketekmall.ketekmall.configs.Link.GET_PROFILE_DETAILS;
import static com.ketekmall.ketekmall.configs.Link.GET_PROMOTION;
import static com.ketekmall.ketekmall.configs.Link.GET_SEARCH_CATEGORY;
import static com.ketekmall.ketekmall.configs.Link.GET_SEARCH_FILTER_CATEGORY;
import static com.ketekmall.ketekmall.configs.Link.GET_SINGLE_CART_ITEM;
...
public class Home extends AppCompatActivity {
    ...
    HomePageListAdapter adapter_item, adapter_item2;
    ViewPager viewPager;
...
//        this.recreate();
    ...
    private void Declare() {
        ...
        _cart_adapter = new CartListAdapter(this, itemList);
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.nav_noti:
                        Intent intent6 = new Intent(Home.this, Notification.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        intent6.putExtra("GET_CATEGORY", GET_CATEGORY + CATEGORY_LIST[12]);
                        intent6.putExtra("ADD_TO_FAVOURITE", ADD_TO_FAVOURITE);
                        intent6.putExtra("ADD_TO_CART", ADD_TO_CART);
                        intent6.putExtra("GET_SEARCH_CATEGORY", GET_SEARCH_CATEGORY + CATEGORY_LIST[12]);
                        intent6.putExtra("GET_FILTER_DISTRICT", GET_FILTER_DISTRICT + CATEGORY_LIST[12]);
                        intent6.putExtra("GET_FILTER_DIVISION", GET_FILTER_DIVISION + CATEGORY_LIST[12]);
                        intent6.putExtra("GET_SEARCH_FILTER_CATEGORY", GET_SEARCH_FILTER_CATEGORY + CATEGORY_LIST[12]);
                        intent6.putExtra("GET_SINGLE_CART_ITEM", GET_SINGLE_CART_ITEM);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(Home.this, Me.class);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                _cart_adapter = new CartListAdapter(Home.this, itemAllDetailsArrayList);
    ...
    private void GotoCategory(int number) {
        ...
        intent.putExtra("GET_CATEGORY", GET_CATEGORY + CATEGORY_LIST[number]);
        intent.putExtra("ADD_TO_FAVOURITE", ADD_TO_FAVOURITE);
        intent.putExtra("ADD_TO_CART", ADD_TO_CART);
        intent.putExtra("GET_SEARCH_CATEGORY", GET_SEARCH_CATEGORY + CATEGORY_LIST[number]);
        intent.putExtra("GET_FILTER_DISTRICT", GET_FILTER_DISTRICT + CATEGORY_LIST[number]);
        intent.putExtra("GET_FILTER_DIVISION", GET_FILTER_DIVISION + CATEGORY_LIST[number]);
        intent.putExtra("GET_SEARCH_FILTER_CATEGORY", GET_SEARCH_FILTER_CATEGORY + CATEGORY_LIST[number]);
        intent.putExtra("GET_SINGLE_CART_ITEM", GET_SINGLE_CART_ITEM);
...
*/
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                Toast.makeText(Home.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    private void InsertNotificationData(final String Name) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ADD_PLAYER_ID,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.i("POST", response);
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    if (strVerify == 0) {
                                        ...
                                        loading_layout.setVisibility(View.GONE);
                                        startActivity(new Intent(Home.this, AddNewProductHome.class));
                                    }
        ...
        if (s1.equals("en")) {
            switch (item.getItemId()) {
                ...
                case R.id.contact_us:
                    Intent intent2 = new Intent(Home.this, AboutKetekMall.class);
                ...
                case R.id.menu_cart:
                    Intent intent = new Intent(Home.this, CartList.class);
                    startActivity(intent);
                    break;

                case R.id.menu_chat:
                    Intent intent3 = new Intent(Home.this, InboxHome.class);
    ...
    private void View_HardSelling() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_CATEGORY + CATEGORY_LIST[11],
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
...
//                                adapter_item.sortArrayHighest();
                                ...
                                adapter_item.setOnItemClickListener(new HomePageListAdapter.OnItemClickListener() {
                                    ...
                                    public void onViewClick(int position) {
                                        Intent detailIntent = new Intent(Home.this, ViewProduct.class);
                                ...
                                Toast.makeText(Home.this, R.string.failed, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    private void View_TopSelling() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_CATEGORY + CATEGORY_LIST[12],
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                adapter_item2 = new HomePageListAdapter(itemList2);
                                adapter_item2.notifyDataSetChanged();
                                gridView_TopSelling.setAdapter(adapter_item2);
                                adapter_item2.setOnItemClickListener(new HomePageListAdapter.OnItemClickListener() {
                                    @Override
                                    public void onViewClick(int position) {
                                        Intent detailIntent = new Intent(Home.this, ViewProduct.class);
    ...
    private void View_Photo() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_PROMOTION,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    adapter = new PageAdapter(Home.this, image);
                                }
    ...
    private void MessageCount() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_ALL_CHAT,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            try {
                                ...
                                if (jsonArray.length() == 0) {
                                    ...
                                    if (getId.equals(strSeller_id)) {
                                        Toast.makeText(Home.this, R.string.cannot_add_your_own_item, Toast.LENGTH_SHORT).show();
                                    } else {
                                                    ...
                                                    public void onResponse(String response) {
                                                        if (response == null) {
                                                            ...
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(Home.this, R.string.added_to_cart, Toast.LENGTH_SHORT).show();
                                                                } else {
                                                                    Toast.makeText(Home.this, R.string.failed_to_add, Toast.LENGTH_SHORT).show();
                                                                }
                                                            } catch (JSONException e) {
                                                                e.printStackTrace();
