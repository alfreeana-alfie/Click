...
public class MyRatingList extends AppCompatActivity {
    ...
    private void Read_Review(final String customer_id) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_BUYER_SIDE_REVIEW,
...
//                                                                Toast.makeText(MyRating.this, "S! ", Toast.LENGTH_SHORT).show();
                                                            ...
                                                            ratingAdapter = new RatingAdapter(MyRatingList.this, ratingList);
                                                            recyclerView.setAdapter(ratingAdapter);
                                                        } else {
                                                            Toast.makeText(MyRatingList.this, R.string.failed, Toast.LENGTH_SHORT).show();
                                                        }
                                    ...
                                    RequestQueue requestQueue = Volley.newRequestQueue(MyRatingList.this);
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(MyRatingList.this, Home.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(MyRatingList.this, Notification.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(MyRatingList.this, Me.class);
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(MyRatingList.this);
                    return false;
                }
            });
        }
