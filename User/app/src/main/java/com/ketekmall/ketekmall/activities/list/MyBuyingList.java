...
import com.ketekmall.ketekmall.activities.order.MyBuyingDetails;
...
//    String TOPIC;
    ...
    MyBuyingListAdapter adapter_item;
    List<Order> itemList;
    String getId;
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(MyBuyingList.this, Home.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(MyBuyingList.this, Notification.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(MyBuyingList.this, Me.class);
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(MyBuyingList.this);
                    return false;
                }
            });
        }
    ...
    private void Buying_List() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_BUYER_ORDER_LIST,
                                                    ...
                                                    public void onResponse(String response) {
                                                        try {
                                                            ...
                                                            if (success.equals("1")) {
                                                                ...
                                                                adapter_item = new MyBuyingListAdapter(MyBuyingList.this, itemList);
                                                                adapter_item.notifyDataSetChanged();
                                                                gridView.setAdapter(adapter_item);
                                                                adapter_item.sortArrayHighest();
                                                                adapter_item.setOnItemClickListener(new MyBuyingListAdapter.OnItemClickListener() {
                                                                    @Override
...
//                        
                                                                    ...
                                                                    public void onReviewClick(int position) {
                                                                        ...
                                                                        Intent intent1 = new Intent(MyBuyingList.this, MyBuyingDetails.class);
                                        ...
                                        RequestQueue requestQueue1 = Volley.newRequestQueue(MyBuyingList.this);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                Toast.makeText(MyBuyingList.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(MyBuyingList.this, R.string.success_update, Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(MyBuyingList.this, R.string.failed, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
//                            Toast.makeText(MyBuying.this, "JSON Parsing Error: " + e.toString(), Toast.LENGTH_SHORT).show();
