...
public class MyLikesList extends AppCompatActivity {
    ...
    GridView gridView;
    MyLikesListAdapter adapter_item;
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(MyLikesList.this, Home.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(MyLikesList.this, Notification.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(MyLikesList.this, UserProfile.class);
    ...
    private void ToolbarSetting() {
        ...
        close_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                itemList.clear();
                adapter_item = new MyLikesListAdapter(itemList, MyLikesList.this);
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(MyLikesList.this);
                    return false;
                }
            });
        }
    ...
    private void View_List() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_FAVOURITE_LIST,
...
//                                Toast.makeText(Saved_Searches_Other.this, "Login! ", Toast.LENGTH_SHORT).show();
                                ...
                                adapter_item.notifyDataSetChanged();
                                gridView.setAdapter(adapter_item);
                                adapter_item.setOnItemClickListener(new MyLikesListAdapter.OnItemClickListener() {
                                    @Override
                                    public void onViewClick(int position) {
                                        Intent detailIntent = new Intent(MyLikesList.this, ViewProduct.class);
                                    ...
                                    public void onDeleteClick(final int position) {
                                        AlertDialog.Builder builder = new AlertDialog.Builder(MyLikesList.this, R.style.MyDialogTheme);
...
//                                                Intent detailIntent = new Intent(Saved_Searches_Other.this, Edit_Item.class);
                                                ...
                                                StringRequest stringRequest = new StringRequest(Request.Method.POST, DELETE_FAVOURITE_PRODUCT,
                                                        new Response.Listener<String>() {
                                                            @Override
                                                            public void onResponse(String response) {
                                                                try {
                                                                    ...
                                                                    if (success.equals("1")) {
                                                                        ...
                                                                        Toast.makeText(MyLikesList.this, R.string.failed, Toast.LENGTH_SHORT).show();
                                                                    }
...
//                                                                    Toast.makeText(MyLikes.this, "JSON Parsing Error: " + e.toString(), Toast.LENGTH_SHORT).show();
                                                ...
                                                RequestQueue requestQueue = Volley.newRequestQueue(MyLikesList.this);
...
//                            Toast.makeText(Saved_Searches_Other.this, "JSON Parsing Error: " + e.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void Search(final String strAd_detail) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_SEARCH_FAVOURITE_PRODUCT,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
