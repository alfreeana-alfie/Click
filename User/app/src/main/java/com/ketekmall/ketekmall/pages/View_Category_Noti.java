...
public class View_Category_Noti extends AppCompatActivity {
    ...
    private void ToolbarSetting() {
        ...
        close_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                itemList.clear();
                adapter_item = new Item_ByCategory_Adapter(itemList, View_Category_Noti.this);
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(View_Category_Noti.this, Notification_Page.class);
...
//        this.recreate();
    ...
    private void Declare() {
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(View_Category_Noti.this, Homepage.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(View_Category_Noti.this, Notification_Page.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(View_Category_Noti.this, Me_Page.class);
        ...
        adapter_division = ArrayAdapter.createFromResource(View_Category_Noti.this, R.array.division, android.R.layout.simple_spinner_item);
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(View_Category_Noti.this);
                    return false;
                }
            });
        }
                            ...
                            try {
                                ...
                                if(jsonArray.length() == 0){
                                    ...
                                    if (getId.equals(strSeller_id)) {
                                        Toast.makeText(View_Category_Noti.this, R.string.cannot_add_your_own_item, Toast.LENGTH_SHORT).show();
                                    } else {
                                                    ...
                                                    public void onResponse(String response) {
                                                        if (response == null) {
                                                            ...
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(View_Category_Noti.this, R.string.added_to_cart, Toast.LENGTH_SHORT).show();
                                                                } else {
                                                                    Toast.makeText(View_Category_Noti.this, R.string.failed_to_add, Toast.LENGTH_SHORT).show();
                                                                }
                                                            } catch (JSONException e) {
                                                                e.printStackTrace();
                                                                Toast.makeText(View_Category_Noti.this, e.toString(), Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                        ...
                                        RequestQueue requestQueue = Volley.newRequestQueue(View_Category_Noti.this);
...
//                                Toast.makeText(Homepage.this, "Login! ", Toast.LENGTH_SHORT).show();
                                ...
                                adapter_item.setOnItemClickListener(new Item_ByCategory_Adapter.OnItemClickListener() {
                                    ...
                                    public void onViewClick(int position) {
                                        Intent detailIntent = new Intent(View_Category_Noti.this, View_Product.class);
                                                    ...
                                                    new Response.Listener<String>() {
                                                        ...
                                                        public void onResponse(String response) {
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(View_Category_Noti.this, R.string.added_to_like, Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(View_Category_Noti.this, R.string.failed, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
