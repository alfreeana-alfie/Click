...
public class MyBuyingDetails extends AppCompatActivity {
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(MyBuyingDetails.this, Home.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(MyBuyingDetails.this, Notification.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(MyBuyingDetails.this, Me.class);
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(MyBuyingDetails.this);
                    return false;
                }
            });
        }
                            ...
                            try {
                                ...
                                if (success.equals("1")) {
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        ...
                                        StringRequest stringRequest = new StringRequest(Request.Method.POST, ADD_NEW_REVIEW,
                                                new Response.Listener<String>() {
                                                    @Override
                                                    public void onResponse(String response) {
                                                        try {
                                                            ...
                                                            if (success.equals("1")) {
                                                                ...
                                                                Toast.makeText(MyBuyingDetails.this, R.string.success_update, Toast.LENGTH_SHORT).show();

                                                                Intent intent = new Intent(MyBuyingDetails.this, Me.class);
...
//                                                            Toast.makeText(Review_Page.this, "JSON Parsing Error: " + e.toString(), Toast.LENGTH_SHORT).show();
                                        ...
                                        RequestQueue requestQueue = Volley.newRequestQueue(MyBuyingDetails.this);
                                        requestQueue.add(stringRequest);
                                    }
                                } else {
                                    Toast.makeText(MyBuyingDetails.this, R.string.failed, Toast.LENGTH_SHORT).show();
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                Toast.makeText(MyBuyingDetails.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
