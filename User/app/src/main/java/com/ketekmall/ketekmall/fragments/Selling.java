...
import com.ketekmall.ketekmall.activities.list.MyIncomeList;
import com.ketekmall.ketekmall.activities.list.BoostAdList;
...
import com.ketekmall.ketekmall.activities.list.ProductRatingList;
    ...
    private void GotoPage(){
        AddNewProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), com.ketekmall.ketekmall.activities.products.AddNewProduct.class);
        ...
        MyProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), MyProductsList.class);
                requireActivity().startActivity(intent);
            }
        });
        ...
        Selling.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), MySellingList.class);
                requireActivity().startActivity(intent);
            }
        });
        ...
        MyRating.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), ProductRatingList.class);
                requireActivity().startActivity(intent);
            }
        });
        ...
        MyIncome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), MyIncomeList.class);
                requireActivity().startActivity(intent);
            }
        });
        ...
        BoostAd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), BoostAdList.class);
                requireActivity().startActivity(intent);
            }
        });
    }
