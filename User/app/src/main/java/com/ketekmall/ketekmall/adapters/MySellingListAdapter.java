...
public class MySellingListAdapter extends RecyclerView.Adapter<MySellingListAdapter.ViewHolder> {
    ...
    public MySellingListAdapter(Context context, List<Order> item_all_details) {
    ...
    @NonNull
    @Override
    public MySellingListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MySellingListAdapter.ViewHolder holder, int position) {
        ...
        }else if(order.getStatus().equals("Unsuccessful")){
            holder.text_status.setText(order.getStatus1());
