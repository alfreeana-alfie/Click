...
public class SellerShopList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(SellerShopList.this, Home.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(SellerShopList.this, Notification.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(SellerShopList.this, Me.class);
        ...
        btn_chat_wsp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (installed) {
                    ...
                    Toast.makeText(SellerShopList.this, "Not Installed", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btn_chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SellerShopList.this, ChatList.class);
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(SellerShopList.this);
                    return false;
                }
            });
        }
                            ...
                            try {
                                ...
                                if(jsonArray.length() == 0){
                                    ...
                                    if (getId.equals(strSeller_id)) {
                                        Toast.makeText(SellerShopList.this, R.string.cannot_add_your_own_item, Toast.LENGTH_SHORT).show();
                                    } else {
                                                    ...
                                                    public void onResponse(String response) {
                                                        if (response == null) {
                                                            ...
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(SellerShopList.this, R.string.added_to_cart, Toast.LENGTH_SHORT).show();
                                                                } else {
                                                                    Toast.makeText(SellerShopList.this, R.string.failed_to_add, Toast.LENGTH_SHORT).show();
                                                                }
                                                            } catch (JSONException e) {
                                                                e.printStackTrace();
                                                                Toast.makeText(SellerShopList.this, e.toString(), Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                        ...
                                        RequestQueue requestQueue = Volley.newRequestQueue(SellerShopList.this);
                        ...
                        if (response == null) {
                            ...
                            try {
                                ...
                                if (success.equals("1")) {
                                    ...
                                    adapter_item = new ProductListAdapter(itemList, SellerShopList.this);
                                    ...
                                    adapter_item.setOnItemClickListener(new ProductListAdapter.OnItemClickListener() {
                                        ...
                                        public void onViewClick(int position) {
                                            Intent detailIntent = new Intent(SellerShopList.this, ViewProduct.class);
                                                            ...
                                                            public void onResponse(String response) {
                                                                if (response == null) {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        if (success.equals("1")) {
                                                                            Toast.makeText(SellerShopList.this, R.string.added_to_like, Toast.LENGTH_SHORT).show();
                                                                        } else {
                                                                            Toast.makeText(SellerShopList.this, R.string.failed_to_add, Toast.LENGTH_SHORT).show();
                                                                        }
                                    ...
                                    Toast.makeText(SellerShopList.this, R.string.failed, Toast.LENGTH_SHORT).show();
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
    ...
    private void getSold(final String seller_id) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_SELLER_PRODUCT_SOLD_NO,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        if (response == null) {
