...
public class Delivery_Add extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(Delivery_Add.this);
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(Delivery_Add.this, Homepage.class);
                    ...
                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(Delivery_Add.this, Edit_Profile.class);
...
//                                    delivery = new Delivery(strDivision, strPrice, strDays);
                                    ...
                                    loading.setVisibility(View.GONE);
                                    buttonSubmit.setVisibility(View.VISIBLE);
                                    Toast.makeText(Delivery_Add.this, "Failed to read", Toast.LENGTH_SHORT).show();
                                }
                            } catch (JSONException e) {
                                loading.setVisibility(View.GONE);
                                buttonSubmit.setVisibility(View.VISIBLE);
                                e.printStackTrace();
                                Toast.makeText(Delivery_Add.this, "JSON Parsing Error: " + e.toString(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    },
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(Delivery_Add.this);
