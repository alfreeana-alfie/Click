...
public class MyIncomeListAdapter extends RecyclerView.Adapter<MyIncomeListAdapter.ViewHolder> {

    Context context;
    private List<OrderDone> item_all_details;

    public MyIncomeListAdapter(Context context, List<OrderDone> item_all_detailsList) {
