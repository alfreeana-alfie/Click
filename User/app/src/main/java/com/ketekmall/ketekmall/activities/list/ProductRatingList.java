...
public class ProductRatingList extends AppCompatActivity {
    ...
    private void Read_Review(final String customer_id) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_SELLER_SIDE_REVIEW,
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_PRODUCT_REVIEW,
                                            new Response.Listener<String>() {
                                                @Override
                                                public void onResponse(String response) {
                                                    try {
...
//                                                                Toast.makeText(MyRating.this, "S! ", Toast.LENGTH_SHORT).show();
                                                            ...
                                                            ratingAdapter = new RatingAdapter(ProductRatingList.this, ratingList);
                                                            recyclerView.setAdapter(ratingAdapter);
                                                        } else {
                                                            Toast.makeText(ProductRatingList.this, R.string.failed, Toast.LENGTH_SHORT).show();
                                                        }
                                    ...
                                    RequestQueue requestQueue = Volley.newRequestQueue(ProductRatingList.this);
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(ProductRatingList.this, Home.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(ProductRatingList.this, Notification.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(ProductRatingList.this, Me.class);
