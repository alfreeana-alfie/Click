...
//        getSession();
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(InboxNotification.this));
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(InboxNotification.this);
                    return false;
                }
            });
        }
                                                        ...
                                                        if(response == null){
                                                            ...
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    ...
                                                                    chat_adapter = new ChatListAdapter(InboxNotification.this, usersArrayList);
                                                                    ...
                                                                    chat_adapter.setOnItemClickListener(new ChatListAdapter.OnItemClickListener() {
                                                                        ...
                                                                        public void onItemClick(int position) {
                                                                            ...
                                                                            Intent chatIntent = new Intent(InboxNotification.this, ChatRoom.class);
                                                                    ...
                                                                    Toast.makeText(InboxNotification.this, R.string.failed, Toast.LENGTH_SHORT).show();
                                                                }
    ...
    private void ToolbarSetting() {
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(InboxNotification.this, Notification.class);
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(InboxNotification.this, Home.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(InboxNotification.this, Notification.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(InboxNotification.this, Me.class);
