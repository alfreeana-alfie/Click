...
public class BoostAdList extends AppCompatActivity {
    ...
    private void getBoost(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GET_BOOST_LIST,
                        ...
                        if(response == null){
                            ...
                            try {
                                ...
                                if (success.equals("1")) {
                                    ...
                                    boostAdListAdapter = new BoostAdListAdapter(BoostAdList.this, item_all_details);
                                    recyclerView.setAdapter(boostAdListAdapter);
                                    boostAdListAdapter.setOnItemClickListener(new BoostAdListAdapter.OnItemClickListener() {
                                        @Override
                                        public void onCancelClick(int position) {
                                            final Item_All_Details item = item_all_details.get(position);
                                            StringRequest stringRequest1 = new StringRequest(Request.Method.POST, CANCEL_BOOST,
                                                    new Response.Listener<String>() {
                                                        @Override
                                                        public void onResponse(String response) {
                                                            if(response == null){
                                                                ...
                                                                try {
                                                                    ...
                                                                    if (success.equals("1")) {
                                                                        Toast.makeText(BoostAdList.this, R.string.success_add, Toast.LENGTH_SHORT).show();
                                                                    } else {
                                                                        Toast.makeText(BoostAdList.this, R.string.failed_to_add, Toast.LENGTH_SHORT).show();
                                                                    }
...
//                                                                    Toast.makeText(BoostAd.this, "JSON Parsing Error: " + e.toString(), Toast.LENGTH_SHORT).show();
                                            ...
                                            RequestQueue requestQueue = Volley.newRequestQueue(BoostAdList.this);
                                            requestQueue.add(stringRequest1);
                                        }
                                    });
                                } else {
                                    Toast.makeText(BoostAdList.this, R.string.failed, Toast.LENGTH_SHORT).show();
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(BoostAdList.this, Home.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(BoostAdList.this, Notification.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(BoostAdList.this, Me.class);
