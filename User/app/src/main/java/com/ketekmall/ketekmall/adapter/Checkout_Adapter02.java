...
public class Checkout_Adapter02 extends RecyclerView.Adapter<Checkout_Adapter02.ViewHolder> {

    Context context;
    private List<Checkout_Data> item_all_details;
    private OnItemClickListener mListerner;

    public Checkout_Adapter02(Context context, List<Checkout_Data> item_all_detailsList) {
