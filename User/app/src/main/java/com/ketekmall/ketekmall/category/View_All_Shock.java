...
public class View_All_Shock extends AppCompatActivity {
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(View_All_Shock.this, Homepage.class);
                        intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent4);
                        break;

//                    case R.id.nav_feed:
//                        Intent intent5 = new Intent(View_All_Shock.this, Feed_page.class);
//                        intent5.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
//                        startActivity(intent5);
//                        break;

                    case R.id.nav_noti:
                        Intent intent6 = new Intent(View_All_Shock.this, Notification_Page.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(View_All_Shock.this, Me_Page.class);
    ...
    private void ToolbarSetting() {
        ...
        close_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                itemList.clear();
                adapter_item = new Item_Adapter(itemList, View_All_Shock.this);
    ...
    private void Declare() {
        ...
        adapter_division = ArrayAdapter.createFromResource(View_All_Shock.this, R.array.division, android.R.layout.simple_spinner_item);
                            ...
                            try {
                                ...
                                if(jsonArray.length() == 0){
                                    ...
                                    if (getId.equals(strSeller_id)) {
                                                    ...
                                                    public void onResponse(String response) {
                                                        if (response == null) {
                                                            ...
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(View_All_Shock.this, "Add To Cart", Toast.LENGTH_SHORT).show();
                                                                } else {
                                                                    Toast.makeText(View_All_Shock.this, "Failed Adding To Favourite", Toast.LENGTH_SHORT).show();
                                                                }
                                                            } catch (JSONException e) {
                                                                e.printStackTrace();
                                                                Toast.makeText(View_All_Shock.this, e.toString(), Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                        ...
                                        RequestQueue requestQueue = Volley.newRequestQueue(View_All_Shock.this);
                                ...
                                if (success.equals("1")) {
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        ...
                                        Toast.makeText(View_All_Shock.this, "Sorry, Already in the cart", Toast.LENGTH_SHORT).show();
...
//                                Toast.makeText(Homepage.this, "Login! ", Toast.LENGTH_SHORT).show();
                                ...
                                adapter_item.setOnItemClickListener(new Item_Adapter.OnItemClickListener() {
                                    ...
                                    public void onViewClick(int position) {
                                        Intent detailIntent = new Intent(View_All_Shock.this, View_Product.class);
                                                    ...
                                                    new Response.Listener<String>() {
                                                        ...
                                                        public void onResponse(String response) {
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(View_All_Shock.this, "Add To Favourite", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(View_All_Shock.this, "Login Failed! ", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
