...
import static com.example.click.category.Camera.AD_DETAIL;
import static com.example.click.category.Camera.DISTRICT;
import static com.example.click.category.Camera.DIVISION;
import static com.example.click.category.Camera.MAIN_CATE;
import static com.example.click.category.Camera.PHOTO;
import static com.example.click.category.Camera.PRICE;
import static com.example.click.category.Camera.SUB_CATE;
import static com.example.click.category.Camera.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Camera.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Camera.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Camera.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
