...
import static com.example.click.category.Men.AD_DETAIL;
import static com.example.click.category.Men.DISTRICT;
import static com.example.click.category.Men.DIVISION;
import static com.example.click.category.Men.MAIN_CATE;
import static com.example.click.category.Men.PHOTO;
import static com.example.click.category.Men.PRICE;
import static com.example.click.category.Men.SUB_CATE;
import static com.example.click.category.Men.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Men.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Men.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Men.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
