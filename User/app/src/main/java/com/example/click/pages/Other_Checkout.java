...
public class Other_Checkout extends AppCompatActivity {
    ...
    private void Declare() {
        ...
        address_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Other_Checkout.this, Edit_Profile.class);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Other_Checkout.this));
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Other_Checkout.this, Cart.class);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                Toast.makeText(Other_Checkout.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                            ...
                                            new Response.Listener<String>() {
                                                ...
                                                public void onResponse(String response) {
                                                    try {
                                                        ...
                                                        if (success.equals("1")) {
                                                            Toast.makeText(Other_Checkout.this, "Success Receipt!", Toast.LENGTH_SHORT).show();
                                                            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_READ_RECEIPTS,
                                                                                                ...
                                                                                                new Response.Listener<String>() {
                                                                                                    ...
                                                                                                    public void onResponse(String response) {
                                                                                                        try {
                                                                                                            ...
                                                                                                            if (success.equals("1")) {
                                                                                                                Toast.makeText(Other_Checkout.this, "Success Approved!", Toast.LENGTH_SHORT).show();
                                                                                                                StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_READ,
                                                                                                                        new Response.Listener<String>() {
                                                                                                                            @Override
                                                                                                                            public void onResponse(String response) {
                                                                                                                                try {
                                                                                                                                    ...
                                                                                                                                    if (success.equals("1")) {
                                                                                                                                        for (int i = 0; i < jsonArray.length(); i++) {
                                                                                                                                            ...
                                                                                                                                            RequestQueue rQueue = Volley.newRequestQueue(Other_Checkout.this);
                                                                                                                                            rQueue.add(request);

                                                                                                                                            Intent intent = new Intent(Other_Checkout.this, After_Place_Order.class);
                                                                                                                                            startActivity(intent);
                                                                                                                ...
                                                                                                                RequestQueue requestQueue = Volley.newRequestQueue(Other_Checkout.this);
                                                                                                                requestQueue.add(stringRequest);
                                                                                                            } else {
                                                                                                                Toast.makeText(Other_Checkout.this, "Failed to read", Toast.LENGTH_SHORT).show();
                                                                                                            }

                                                                                                        } catch (JSONException e) {
                                                                                                            e.printStackTrace();
                                                                                                            Toast.makeText(Other_Checkout.this, "JSON Parsing Error: " + e.toString(), Toast.LENGTH_SHORT).show();
                                                                                                        }
                                                                                                    }
                                                                                                },
                                                                                                new Response.ErrorListener() {
                                                                                                    @Override
                                                                                                    public void onErrorResponse(VolleyError error) {
                                                                                                        Toast.makeText(Other_Checkout.this, "Error: " + error.toString(), Toast.LENGTH_SHORT).show();
                                                                                                    }
                                                                                                }) {
                                                                                            @Override
                                                                                            protected Map<String, String> getParams() throws AuthFailureError {
                                                                    ...
                                                                    new Response.ErrorListener() {
                                                                        @Override
                                                                        public void onErrorResponse(VolleyError error) {
                                                                            Toast.makeText(Other_Checkout.this, "JSON Parsing Error: " + error.toString(), Toast.LENGTH_SHORT).show();
                                                                        }
                                                                    }) {
                                                                @Override
                                                                protected Map<String, String> getParams() throws AuthFailureError {
                                    ...
                                    RequestQueue requestQueue2 = Volley.newRequestQueue(Other_Checkout.this);
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_READ_DELIVERY,
                                            new Response.Listener<String>() {
                                                ...
                                                public void onResponse(String response) {
                                                    try {
                                                        ...
                                                        e.printStackTrace();
                                                        Toast.makeText(Other_Checkout.this, e.toString(), Toast.LENGTH_SHORT).show();
                                            ...
                                            new Response.ErrorListener() {
                                                @Override
                                                public void onErrorResponse(VolleyError error) {
                                                    Toast.makeText(Other_Checkout.this, error.toString(), Toast.LENGTH_SHORT).show();
                                                }
                                            }) {
                                        @Override
                                        protected Map<String, String> getParams() throws AuthFailureError {
    ...
    private void sendNotification(JSONObject notification) {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(FCM_API, notification,
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Other_Checkout.this, "Request error", Toast.LENGTH_LONG).show();
