...
public class MyRatingSeller extends AppCompatActivity {
...
//                                                                Toast.makeText(MyRating.this, "S! ", Toast.LENGTH_SHORT).show();
                                                            ...
                                                            ratingAdapter = new RatingAdapter(MyRatingSeller.this, ratingList);
                                                            recyclerView.setAdapter(ratingAdapter);
                                                        } else {
                                                            Toast.makeText(MyRatingSeller.this, "Failed! ", Toast.LENGTH_SHORT).show();
                                                        }
                                    ...
                                    RequestQueue requestQueue = Volley.newRequestQueue(MyRatingSeller.this);
                                    requestQueue.add(stringRequest);
                                }
                            } else {
                                Toast.makeText(MyRatingSeller.this, "Login Failed! ", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    private void ToolbarSettings(){
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MyRatingSeller.this, Profile_Page.class);
        ...
        bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent4 = new Intent(MyRatingSeller.this, Homepage.class);
...
//                        break;
                    ...
                    case R.id.nav_noti:
                        Intent intent6 = new Intent(MyRatingSeller.this, Noti_Page.class);
                        intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent6);
                        break;

                    case R.id.nav_edit_profile:
                        Intent intent1 = new Intent(MyRatingSeller.this, Profile_Page.class);
