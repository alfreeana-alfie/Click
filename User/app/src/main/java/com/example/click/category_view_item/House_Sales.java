...
import static com.example.click.category.House_Sales.AD_DETAIL;
import static com.example.click.category.House_Sales.DISTRICT;
import static com.example.click.category.House_Sales.DIVISION;
import static com.example.click.category.House_Sales.MAIN_CATE;
import static com.example.click.category.House_Sales.PHOTO;
import static com.example.click.category.House_Sales.PRICE;
import static com.example.click.category.House_Sales.SUB_CATE;
import static com.example.click.category.House_Sales.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(House_Sales.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(House_Sales.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(House_Sales.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
