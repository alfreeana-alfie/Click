...
import static com.example.click.category.Electronics.AD_DETAIL;
import static com.example.click.category.Electronics.DISTRICT;
import static com.example.click.category.Electronics.DIVISION;
import static com.example.click.category.Electronics.MAIN_CATE;
import static com.example.click.category.Electronics.PHOTO;
import static com.example.click.category.Electronics.PRICE;
import static com.example.click.category.Electronics.SUB_CATE;
import static com.example.click.category.Electronics.USERID;
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Electronics.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Electronics.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
