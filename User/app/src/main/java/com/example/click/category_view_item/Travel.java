...
import static com.example.click.category.Travel.AD_DETAIL;
import static com.example.click.category.Travel.DISTRICT;
import static com.example.click.category.Travel.DIVISION;
import static com.example.click.category.Travel.MAIN_CATE;
import static com.example.click.category.Travel.PHOTO;
import static com.example.click.category.Travel.PRICE;
import static com.example.click.category.Travel.SUB_CATE;
import static com.example.click.category.Travel.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Travel.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Travel.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Travel.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
