...
import static com.example.click.category.Service.AD_DETAIL;
import static com.example.click.category.Service.DISTRICT;
import static com.example.click.category.Service.DIVISION;
import static com.example.click.category.Service.MAIN_CATE;
import static com.example.click.category.Service.PHOTO;
import static com.example.click.category.Service.PRICE;
import static com.example.click.category.Service.SUB_CATE;
import static com.example.click.category.Service.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Service.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Service.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Service.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
