                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                adapter_item = new Order_BuyerAdapter(Buying.this, itemList);
                                ...
                                adapter_item.setOnItemClickListener(new Order_BuyerAdapter.OnItemClickListener() {
                                                ...
                                                new Response.Listener<String>() {
                                                    ...
                                                    public void onResponse(String response) {
                                                        try {
                                                            ...
                                                            if (success.equals("1")) {
                                                                Toast.makeText(Buying.this, "Your order has been canceled", Toast.LENGTH_SHORT).show();
                                                                                ...
                                                                                try {
                                                                                    ...
                                                                                    if (success.equals("1")) {
                                                                                        for (int i = 0; i < jsonArray.length(); i++) {
                                                                                            ...
                                                                                            RequestQueue rQueue = Volley.newRequestQueue(Buying.this);
                                                                                            rQueue.add(request);


                                                                                        }
                                                                                    } else {
                                                                                        Toast.makeText(Buying.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                                                                                    }
                                                                                } catch (JSONException e) {
                                                                                    e.printStackTrace();
                                                                                }
                                                                ...
                                                                RequestQueue requestQueue = Volley.newRequestQueue(Buying.this);
                                                            ...
                                                            e.printStackTrace();
                                                            Toast.makeText(Buying.this, e.toString(), Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                },
                                                new Response.ErrorListener() {
                                                    @Override
                                                    public void onErrorResponse(VolleyError error) {
                                                        Toast.makeText(Buying.this, error.toString(), Toast.LENGTH_SHORT).show();
                                                    }
                                                }) {
                                            @Override
                                            protected Map<String, String> getParams() throws AuthFailureError {
                                    ...
                                    public void onReviewClick(int position) {
                                        ...
                                        Intent intent1 = new Intent(Buying.this, Review_Page_Other.class);
                            ...
                            e.printStackTrace();
                            Toast.makeText(Buying.this, "JSON Parsing Error: " + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(Buying.this, "Successfully Updated", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(Buying.this, "Failed to read", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(Buying.this, "JSON Parsing Error: " + e.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void sendNotification(JSONObject notification) {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(FCM_API, notification,
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Buying.this, "Request error", Toast.LENGTH_LONG).show();
