...
import static com.example.click.category.Computer.AD_DETAIL;
import static com.example.click.category.Computer.DISTRICT;
import static com.example.click.category.Computer.DIVISION;
import static com.example.click.category.Computer.MAIN_CATE;
import static com.example.click.category.Computer.PHOTO;
import static com.example.click.category.Computer.PRICE;
import static com.example.click.category.Computer.SUB_CATE;
import static com.example.click.category.Computer.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Computer.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Computer.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Computer.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
