...
import static com.example.click.category.Business.AD_DETAIL;
import static com.example.click.category.Business.DISTRICT;
import static com.example.click.category.Business.DIVISION;
import static com.example.click.category.Business.MAIN_CATE;
import static com.example.click.category.Business.PHOTO;
import static com.example.click.category.Business.PRICE;
import static com.example.click.category.Business.SUB_CATE;
import static com.example.click.category.Business.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Business.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Business.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Business.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
