...
import static com.example.click.category.Grocery.AD_DETAIL;
import static com.example.click.category.Grocery.DISTRICT;
import static com.example.click.category.Grocery.DIVISION;
import static com.example.click.category.Grocery.MAIN_CATE;
import static com.example.click.category.Grocery.PHOTO;
import static com.example.click.category.Grocery.PRICE;
import static com.example.click.category.Grocery.SUB_CATE;
import static com.example.click.category.Grocery.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Grocery.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Grocery.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Grocery.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
