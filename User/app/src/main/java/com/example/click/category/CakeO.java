...
public class CakeO extends AppCompatActivity {

    private static String URL_READ = "https://ketekmall.com/ketekmall/category/read_cake.php";
    ...
    private static String URL_SEARCH = "https://ketekmall.com/ketekmall/search/read_cake.php";
    private static String URL_FILTER_DISTRICT = "https://ketekmall.com/ketekmall/filter_district/read_cake.php";
    private static String URL_FILTER_DIVISION = "https://ketekmall.com/ketekmall/filter_division/read_cake.php";
    private static String URL_FILTER_SEARCH = "https://ketekmall.com/ketekmall/filter_search_division/read_cake.php";
    ...
    private void ToolbarSetting() {
        ...
        close_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                itemList.clear();
                adapter_item = new Item_Adapter(itemList, CakeO.this);
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CakeO.this, Homepage.class);
    ...
    private void Declare() {
        ...
        adapter_division = ArrayAdapter.createFromResource(CakeO.this, R.array.division, android.R.layout.simple_spinner_item);
                            ...
                            if (success.equals("1")) {
                                ...
                                adapter_item.setOnItemClickListener(new Item_Adapter.OnItemClickListener() {
                                    ...
                                    public void onViewClick(int position) {
                                        Intent detailIntent = new Intent(CakeO.this, View_Item_Single.class);
                                    ...
                                    public void onAddtoFavClick(int position) {
                                        ...
                                        if (getId.equals(item.getSeller_id())) {
                                            Toast.makeText(CakeO.this, "Sorry, Cannot add your own item", Toast.LENGTH_SHORT).show();
                                        } else {
                                            StringRequest stringRequest1 = new StringRequest(Request.Method.POST, URL_ADD_FAV,
                                                    new Response.Listener<String>() {
                                                        ...
                                                        public void onResponse(String response) {
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(CakeO.this, "Add To Favourite", Toast.LENGTH_SHORT).show();

                                                                }

                                                            } catch (JSONException e) {
                                                                e.printStackTrace();
                                                                Toast.makeText(CakeO.this, e.toString(), Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    },
                                                    new Response.ErrorListener() {
                                                        ...
                                                        public void onErrorResponse(VolleyError error) {
                                                            Toast.makeText(CakeO.this, error.toString(), Toast.LENGTH_SHORT).show();
                                                        }
                                                    }) {
                                                @Override
                                            ...
                                            RequestQueue requestQueue = Volley.newRequestQueue(CakeO.this);
                                                    ...
                                                    new Response.Listener<String>() {
                                                        ...
                                                        public void onResponse(String response) {
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(CakeO.this, "Add To Cart", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(CakeO.this, "Login Failed! ", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
