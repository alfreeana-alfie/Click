...
import static com.example.click.category.Motorcycles.AD_DETAIL;
import static com.example.click.category.Motorcycles.DISTRICT;
import static com.example.click.category.Motorcycles.DIVISION;
import static com.example.click.category.Motorcycles.MAIN_CATE;
import static com.example.click.category.Motorcycles.PHOTO;
import static com.example.click.category.Motorcycles.PRICE;
import static com.example.click.category.Motorcycles.SUB_CATE;
import static com.example.click.category.Motorcycles.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Motorcycles.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Motorcycles.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Motorcycles.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
