...
import static com.example.click.category.Pets.AD_DETAIL;
import static com.example.click.category.Pets.DISTRICT;
import static com.example.click.category.Pets.DIVISION;
import static com.example.click.category.Pets.MAIN_CATE;
import static com.example.click.category.Pets.PHOTO;
import static com.example.click.category.Pets.PRICE;
import static com.example.click.category.Pets.SUB_CATE;
import static com.example.click.category.Pets.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Pets.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Pets.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Pets.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
