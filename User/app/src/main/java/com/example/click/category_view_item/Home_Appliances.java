...
import static com.example.click.category.Home_Appliances.AD_DETAIL;
import static com.example.click.category.Home_Appliances.DISTRICT;
import static com.example.click.category.Home_Appliances.DIVISION;
import static com.example.click.category.Home_Appliances.MAIN_CATE;
import static com.example.click.category.Home_Appliances.PHOTO;
import static com.example.click.category.Home_Appliances.PRICE;
import static com.example.click.category.Home_Appliances.SUB_CATE;
import static com.example.click.category.Home_Appliances.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Home_Appliances.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Home_Appliances.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Home_Appliances.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
