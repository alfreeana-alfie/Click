...
import static com.example.click.category.Mom.AD_DETAIL;
import static com.example.click.category.Mom.DISTRICT;
import static com.example.click.category.Mom.DIVISION;
import static com.example.click.category.Mom.MAIN_CATE;
import static com.example.click.category.Mom.PHOTO;
import static com.example.click.category.Mom.PRICE;
import static com.example.click.category.Mom.SUB_CATE;
import static com.example.click.category.Mom.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Mom.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Mom.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Mom.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
