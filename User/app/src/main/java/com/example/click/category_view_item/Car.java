...
import static com.example.click.category.Car.AD_DETAIL;
import static com.example.click.category.Car.DISTRICT;
import static com.example.click.category.Car.DIVISION;
import static com.example.click.category.Car.MAIN_CATE;
import static com.example.click.category.Car.PHOTO;
import static com.example.click.category.Car.PRICE;
import static com.example.click.category.Car.SUB_CATE;
import static com.example.click.category.Car.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Car.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Car.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Car.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
