...
import static com.example.click.category.Handcraft.AD_DETAIL;
import static com.example.click.category.Handcraft.DISTRICT;
import static com.example.click.category.Handcraft.DIVISION;
import static com.example.click.category.Handcraft.MAIN_CATE;
import static com.example.click.category.Handcraft.PHOTO;
import static com.example.click.category.Handcraft.PRICE;
import static com.example.click.category.Handcraft.SUB_CATE;
import static com.example.click.category.Handcraft.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Handcraft.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Handcraft.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Handcraft.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
