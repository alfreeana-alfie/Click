...
import static com.example.click.category.Car_Accessories.AD_DETAIL;
import static com.example.click.category.Car_Accessories.DISTRICT;
import static com.example.click.category.Car_Accessories.DIVISION;
import static com.example.click.category.Car_Accessories.MAIN_CATE;
import static com.example.click.category.Car_Accessories.PHOTO;
import static com.example.click.category.Car_Accessories.PRICE;
import static com.example.click.category.Car_Accessories.SUB_CATE;
import static com.example.click.category.Car_Accessories.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Car_Accessories.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Car_Accessories.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Car_Accessories.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
