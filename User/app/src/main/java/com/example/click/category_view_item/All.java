...
import static com.example.click.category.All.AD_DETAIL;
import static com.example.click.category.All.DISTRICT;
import static com.example.click.category.All.DIVISION;
import static com.example.click.category.All.MAIN_CATE;
import static com.example.click.category.All.PHOTO;
import static com.example.click.category.All.PRICE;
import static com.example.click.category.All.SUB_CATE;
import static com.example.click.category.All.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(All.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                ...
                StringRequest stringRequest2 = new StringRequest(Request.Method.POST, URL_ADD_CART,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (success.equals("1")) {
                                        Toast.makeText(All.this, "Add To Cart", Toast.LENGTH_SHORT).show();

                                    }

                                } catch (JSONException e) {
                                    e.printStackTrace();
                                    Toast.makeText(All.this, e.toString(), Toast.LENGTH_SHORT).show();
                                }
                            }
                        },
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(All.this, error.toString(), Toast.LENGTH_SHORT).show();
                            }
                        }) {
                    @Override
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(All.this);
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(All.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(All.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
