...
public class Agriculture_O extends AppCompatActivity {
    ...
    private void ToolbarSetting() {
        ...
        close_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                itemList.clear();
                adapter_item = new Item_Adapter(itemList, Agriculture_O.this);
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Agriculture_O.this, Homepage.class);
    ...
    private void Declare() {
        ...
        adapter_division = ArrayAdapter.createFromResource(Agriculture_O.this, R.array.division, android.R.layout.simple_spinner_item);
...
//                                Toast.makeText(Homepage.this, "Login! ", Toast.LENGTH_SHORT).show();
                                ...
                                adapter_item.setOnItemClickListener(new Item_Adapter.OnItemClickListener() {
                                    ...
                                    public void onViewClick(int position) {
                                        Intent detailIntent = new Intent(Agriculture_O.this, View_Item_Single.class);
                                    ...
                                    public void onAddtoFavClick(int position) {
                                        ...
                                        if (getId.equals(item.getSeller_id())) {
                                            Toast.makeText(Agriculture_O.this, "Sorry, Cannot add your own item", Toast.LENGTH_SHORT).show();
                                        } else {
                                            StringRequest stringRequest1 = new StringRequest(Request.Method.POST, URL_ADD_FAV,
                                                    new Response.Listener<String>() {
                                                        ...
                                                        public void onResponse(String response) {
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(Agriculture_O.this, "Add To Favourite", Toast.LENGTH_SHORT).show();

                                                                }

                                                            } catch (JSONException e) {
                                                                e.printStackTrace();
                                                                Toast.makeText(Agriculture_O.this, e.toString(), Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    },
                                                    new Response.ErrorListener() {
                                                        ...
                                                        public void onErrorResponse(VolleyError error) {
                                                            Toast.makeText(Agriculture_O.this, error.toString(), Toast.LENGTH_SHORT).show();
                                                        }
                                                    }) {
                                                @Override
                                            ...
                                            RequestQueue requestQueue = Volley.newRequestQueue(Agriculture_O.this);
                                                    ...
                                                    new Response.Listener<String>() {
                                                        ...
                                                        public void onResponse(String response) {
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(Agriculture_O.this, "Add To Cart", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(Agriculture_O.this, "Login Failed! ", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
