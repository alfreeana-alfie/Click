...
public class Shopping_Cart extends AppCompatActivity {
    ...
    private void Declare() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Shopping_Cart.this));
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                item_cart_adapter = new Item_Cart_Adapter(Shopping_Cart.this, itemAllDetailsArrayList);
                                ...
                                item_cart_adapter.setOnItemClickListener(new Item_Cart_Adapter.OnItemClickListener() {
                                    ...
                                    public void onDeleteClick(final int position) {
                                        AlertDialog.Builder builder = new AlertDialog.Builder(Shopping_Cart.this, R.style.MyDialogTheme);
...
//                                                                        Toast.makeText(Shopping_Cart.this, "Failed to read", Toast.LENGTH_SHORT).show();
                                                                    }
                                                                } catch (JSONException e) {
                                                                    e.printStackTrace();
                                                                    Toast.makeText(Shopping_Cart.this, "JSON Parsing Error: " + e.toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                        },
                                                ...
                                                RequestQueue requestQueue = Volley.newRequestQueue(Shopping_Cart.this);
