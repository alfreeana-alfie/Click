...
public class Mom extends AppCompatActivity {
    ...
    private static String URL_READ = "https://ketekmall.com/ketekmall/category/read_category_mom.php";
    ...
    private static String URL_SEARCH = "https://ketekmall.com/ketekmall/search/read_category_mom.php";
    private static String URL_FILTER_DISTRICT = "https://ketekmall.com/ketekmall/filter_district/read_filter_mom.php";
    private static String URL_FILTER_DIVISION = "https://ketekmall.com/ketekmall/filter_division/read_filter_mom.php";
    private static String URL_FILTER_SEARCH = "https://ketekmall.com/ketekmall/filter_search_division/read_category_mom.php";
    ...
    private void ToolbarSetting() {
        ...
        close_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                itemList.clear();
                adapter_item = new Item_Adapter(itemList, Mom.this);
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Mom.this, Homepage.class);
    ...
    private void Declare() {
        ...
        adapter_division = ArrayAdapter.createFromResource(Mom.this, R.array.division, android.R.layout.simple_spinner_item);
                            ...
                            if (success.equals("1")) {
                                ...
                                adapter_item.setOnItemClickListener(new Item_Adapter.OnItemClickListener() {
                                    ...
                                    public void onViewClick(int position) {
                                        Intent detailIntent = new Intent(Mom.this, com.example.click.category_view_item.Mom.class);
                                    ...
                                    public void onAddtoFavClick(int position) {
                                        ...
                                        if (getId.equals(item.getSeller_id())) {
                                            Toast.makeText(Mom.this, "Sorry, Cannot add your own item", Toast.LENGTH_SHORT).show();
                                        } else {
                                            StringRequest stringRequest1 = new StringRequest(Request.Method.POST, URL_ADD_FAV,
                                                    new Response.Listener<String>() {
                                                        ...
                                                        public void onResponse(String response) {
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(Mom.this, "Add To Favourite", Toast.LENGTH_SHORT).show();

                                                                }

                                                            } catch (JSONException e) {
                                                                e.printStackTrace();
                                                                Toast.makeText(Mom.this, e.toString(), Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    },
                                                    new Response.ErrorListener() {
                                                        ...
                                                        public void onErrorResponse(VolleyError error) {
                                                            Toast.makeText(Mom.this, error.toString(), Toast.LENGTH_SHORT).show();
                                                        }
                                                    }) {
                                                @Override
                                            ...
                                            RequestQueue requestQueue = Volley.newRequestQueue(Mom.this);
                                                    ...
                                                    new Response.Listener<String>() {
                                                        ...
                                                        public void onResponse(String response) {
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    Toast.makeText(Mom.this, "Add To Cart", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(Mom.this, "Login Failed! ", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
