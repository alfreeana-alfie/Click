...
import static com.example.click.category.Women.AD_DETAIL;
import static com.example.click.category.Women.DISTRICT;
import static com.example.click.category.Women.DIVISION;
import static com.example.click.category.Women.MAIN_CATE;
import static com.example.click.category.Women.PHOTO;
import static com.example.click.category.Women.PRICE;
import static com.example.click.category.Women.SUB_CATE;
import static com.example.click.category.Women.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Women.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(Women.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(Women.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
