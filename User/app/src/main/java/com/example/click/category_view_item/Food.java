...
import static com.example.click.category.Food.AD_DETAIL;
import static com.example.click.category.Food.DISTRICT;
import static com.example.click.category.Food.DIVISION;
import static com.example.click.category.Food.MAIN_CATE;
import static com.example.click.category.Food.PHOTO;
import static com.example.click.category.Food.PRICE;
import static com.example.click.category.Food.SUB_CATE;
import static com.example.click.category.Food.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Food.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                ...
                StringRequest stringRequest2 = new StringRequest(Request.Method.POST, URL_ADD_CART,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (success.equals("1")) {
                                        Toast.makeText(Food.this, "Add To Cart", Toast.LENGTH_SHORT).show();

                                    }

                                } catch (JSONException e) {
                                    e.printStackTrace();
                                    Toast.makeText(Food.this, e.toString(), Toast.LENGTH_SHORT).show();
                                }
                            }
                        },
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(Food.this, error.toString(), Toast.LENGTH_SHORT).show();
                            }
                        }) {
                    @Override
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                Toast.makeText(Food.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
