...
import com.example.click.adapter.Order_BuyerAdapter;
                                    ...
                                    public void onCancelClick(int position) {
                                        ...
                                        StringRequest stringRequest1 = new StringRequest(Request.Method.POST, URL_DELETE_ORDER,
                                                ...
                                                new Response.ErrorListener() {
                                                    @Override
                                                    public void onErrorResponse(VolleyError error) {
                                                        Toast.makeText(MyBuying.this, error.toString(), Toast.LENGTH_SHORT).show();
                                                    }
                                                }) {
                                            @Override
                                            protected Map<String, String> getParams() throws AuthFailureError {
    ...
    private void ToolbarSettings(){
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MyBuying.this, Me_Page.class);
