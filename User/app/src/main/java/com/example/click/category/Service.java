...
public class Service extends AppCompatActivity {
    ...
    private static String URL_READ = "https://ketekmall.com/ketekmall/category/read_category_services.php";
    ...
    private static String URL_SEARCH = "https://ketekmall.com/ketekmall/search/read_category_services.php";
    private static String URL_FILTER_DISTRICT = "https://ketekmall.com/ketekmall/filter_district/read_filter_services.php";
    private static String URL_FILTER_DIVISION = "https://ketekmall.com/ketekmall/filter_division/read_filter_services.php";
    private static String URL_FILTER_SEARCH = "https://ketekmall.com/ketekmall/filter_search_division/read_category_services.php";
    ...
    private void ToolbarSetting() {
        ...
        close_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                itemList.clear();
                adapter_item = new Item_Adapter(itemList, Service.this);
                            ...
                            if (success.equals("1")) {
                                ...
                                adapter_item.setOnItemClickListener(new Item_Adapter.OnItemClickListener() {
                                    ...
                                    public void onViewClick(int position) {
                                        Intent detailIntent = new Intent(Service.this, com.example.click.category_view_item.Service.class);
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                adapter_item.setOnItemClickListener(new Item_Adapter.OnItemClickListener() {
                                    @Override
                                    public void onViewClick(int position) {
                                        Intent detailIntent = new Intent(Service.this, All.class);
                                        Item_All_Details item = itemList.get(position);
