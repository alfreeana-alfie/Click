...
import static com.example.click.category.House_Rent.AD_DETAIL;
import static com.example.click.category.House_Rent.DISTRICT;
import static com.example.click.category.House_Rent.DIVISION;
import static com.example.click.category.House_Rent.MAIN_CATE;
import static com.example.click.category.House_Rent.PHOTO;
import static com.example.click.category.House_Rent.PRICE;
import static com.example.click.category.House_Rent.SUB_CATE;
import static com.example.click.category.House_Rent.USERID;
    ...
    private void Declare() {
        ...
        add_to_cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(House_Rent.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Intent intent = new Intent(House_Rent.this, Chat.class);
                                    startActivity(intent);
                                }
                            } else {
                                Toast.makeText(House_Rent.this, "Incorrect Information", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
